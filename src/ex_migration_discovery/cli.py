...
def main():
 ...
 c.add_argument("--migration-id",required=True,help="Stable closet or migration identifier")
 ...
 try: print(Collector(dev,Path(a.output),a.duration,a.interval,a.migration_id).run())
 finally: dev.close()
